...
import { popularBodyStyles, popularMakes, popularModels } from "@/mockdata/search-bar-data"
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    {popularBodyStyles.map((item) => (
                      <button
                        ...
                        className="text-foreground text-left text-sm hover:text-primary hover:underline transition-colors"
                      >
